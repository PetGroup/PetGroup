...
- (void)viewDidLoad
{
    ...
    self.PhoneNoTF = [[UITextField alloc]initWithFrame:CGRectMake(111.25, 91+diffH, 175, 20)];
    ...
    self.passWordTF = [[UITextField alloc]initWithFrame:CGRectMake(111.25, 131+diffH, 175, 20)];
