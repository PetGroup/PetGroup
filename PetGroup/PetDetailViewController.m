    ...
    switch (indexPath.section) {
        ...
        case 2:
        {
            ...
            else
            {
                ...
                [cell.headImageV setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BaseImageUrl,self.hostInfo.headImgArray.count>0?[self.hostInfo.headImgArray objectAtIndex:0]:@""]] placeholderImage:[self.hostInfo.gender isEqualToString:@"male"]?[UIImage imageNamed:@"placeholderman"]:[UIImage imageNamed:@"placeholderwoman"]];
