...
@interface HeadImageCutViewController ()<UIScrollViewDelegate,UIActionSheetDelegate,EGOImageViewDelegate,sharePlatformViewDelegate>
...
@implementation HeadImageCutViewController
@synthesize delegate;
...
- (void)viewDidLoad
{
    ...
    if (self.oneImage) {
        ...
        UIView * toobarV = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height-65, 320, 65)];
        toobarV.backgroundColor = [UIColor blackColor];
        toobarV.alpha = 0.7;
        [self.view addSubview:toobarV];
        UIButton * cancelBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [cancelBtn setFrame:CGRectMake(0, self.view.frame.size.height-60, 80, 50)];
        [self.view addSubview:cancelBtn];
        [cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
        [cancelBtn.titleLabel setFont:[UIFont systemFontOfSize:19]];
        ...
        [sendBtn setFrame:CGRectMake(240, self.view.frame.size.height-60, 80, 50)];
        [self.view addSubview:sendBtn];
        [sendBtn setTitle:@"发送" forState:UIControlStateNormal];
        [sendBtn.titleLabel setFont:[UIFont systemFontOfSize:19]];
        [sendBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [sendBtn addTarget:self action:@selector(confirmSend) forControlEvents:UIControlEventTouchUpInside];
...
{
    [hud show:NO];
    [self performSelector:@selector(finalCut) withObject:nil afterDelay:0.1];
//    sleep(0.5);
//    [self.delegate CutHeadImageSucceed:self.oneImage];
