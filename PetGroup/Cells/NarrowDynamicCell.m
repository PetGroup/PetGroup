...
@interface NarrowDynamicCell ()<OHAttributedLabelDelegate,UIActionSheetDelegate,UIAlertViewDelegate>
...
-(void)layoutSubviews
{
    ...
    _moveB.frame = CGRectMake(240, origin, 30, 30);
...
//    
    ...
    _replyCountL.frame = CGRectMake(270, origin, 30, 30);
